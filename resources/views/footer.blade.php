@php
    ...
    $menu_footer_1 = App\Models\Menu::where('is_active', true)->where('section', 'footer_1')->get()->toArray();
    ...
    $menu_footer_2 = App\Models\Menu::where('is_active', true)->where('section', 'footer_2')->get()->toArray();
    ...
    $menu_footer_3 = App\Models\Menu::where('is_active', true)->where('section', 'footer_3')->get()->toArray();
